...
class RampEngine {
  ...
  /**
   * Полностью сбрасывает stop-состояние поезда.
   * Вызывается при реконнекте хаба: если предыдущий _stopping не успел
   * сброситься за 900 мс, следующий stopNow будет ошибочно дедуплицирован
   * и BLE-команда не уйдёт новому мотору.
   *
   * @param {string} trainId
   */
